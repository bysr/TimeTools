...
public class PowerDateUtils {
	...
	public static String getDateYear(int year, int month) {
		long time = componentYearToTimestamp(year, month);
		return Date1String(time);
	...
	public static long componentYearToTimestamp(int year, int month) {
	 ...
	 * @return
	 */
	public static String Date1String(long time) {
		if (time == 0) {
			return "";
		}
